...
router.put('/experience',[
  ...
  try {
    ...
    if(removeindex===-1){
      ...
      return res.status(400).json({msg:'there is no experience  found'});
    }
    ...
    console.log(err.message);
    res.status(500).json({"msg":err.array()})
  }
  ...
  // @route /education add education  to profile
  // @desc  add education to profile
  // @private only valid user can add eduaction to profile
  ...
  try {
    ...
    if(removeindex===-1){
      ...
      return res.status(400).json({msg:'there is no education  found'});
    }
    ...
    res.json({user:"education delted"});
  } catch (err) {
    console.log(err.message);
    res.status(500).json({"msg":err.array()})
  }
  ...
  // @route /github/user Get GitHub User By username
  
  // @desc fetching github repositries 
